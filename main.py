...
# This part is image labels setting start 
        ...
        std_b1 = Button(bg_img,command=self.data_pannels,image=self.std_img1,cursor="hand2")
        std_b1.place(x=250,y=100,width=180,height=180)

        std_b1_1 = Button(bg_img,command=self.data_pannels,text="Data Pannel",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
        ...
        tra_b1_1.place(x=250,y=510,width=180,height=45)
         ...
         # Photo  
        pho_img_btn=Image.open(r"Images_GUI\log1.png")
