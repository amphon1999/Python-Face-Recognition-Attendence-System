...
class Attendance:
    ...
    def __init__(self,root):
        ...
        #create table 
        self.attendanceReport_left = ttk.Treeview(table_frame,column=("ID","Type","Name","Time","Date","Attend"),xscrollcommand=scroll_x.set,yscrollcommand=scroll_y.set)
        ...
        self.attendanceReport_left.column("Type",width=100)
        ...
        #create table 
        self.attendanceReport = ttk.Treeview(table_frame,column=("ID","Type","Name","Time","Date","Attend"),xscrollcommand=scroll_x.set,yscrollcommand=scroll_y.set)
        ...
        self.attendanceReport.column("Type",width=100)
